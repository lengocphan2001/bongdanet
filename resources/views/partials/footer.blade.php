<footer class="bg-black text-gray-300 mt-auto">
    <div class="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div class="text-center mb-3">
            ...
            <nav class="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-green-500 text-xs sm:text-sm mb-4">
                ...
                <a href="#" class="text-green-500 hover:text-green-400 transition-colors">Liên hệ</a>
                <span class="text-green-500 hidden sm:inline">-</span>
                <a href="#" class="text-green-500 hover:text-green-400 transition-colors">Điều khoản sử dụng</a>
                <span class="text-green-500 hidden sm:inline">-</span>
        ...
        <div class="space-y-2 sm:space-y-3 text-xs sm:text-sm">
            ...
            <div class="flex items-center justify-center gap-3 sm:gap-4 pt-3">
                ...
                <a href="#" class="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-white/10 hover:bg-[#1877F2] rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg" aria-label="Facebook">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 fill-white group-hover:fill-white transition-colors" viewBox="0 0 24 24">
            ...
            <p class="text-gray-300 pt-2">Liên hệ quảng cáo: <a href="mailto:keobongda.co" class="text-green-500 hover:text-green-400">keobongda.co</a></p>
        </div>
    </div>
    ...
    <button 
        id="scroll-to-top"
        class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-gray-400 hover:bg-gray-500 text-black rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center transition-all opacity-0 pointer-events-none z-50 shadow-lg"
