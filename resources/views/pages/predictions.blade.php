            ...
            <main class="flex-1 min-w-0 order-1 lg:order-1">
                ...
                <div class="mb-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <h2 class="text-lg font-bold text-green-600 uppercase">NHẬN ĐỊNH KÈO NHÀ CÁI TRỰC TUYẾN</h2>
                    </div>
                </div>

                {{-- Predictions List --}}
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 divide-y divide-gray-200 mb-6">
                        ...
                        <a href="{{ $matchUrl }}" class="block p-3 sm:p-4 hover:bg-green-50 transition-colors group">
                            <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                                ...
                                <div class="w-full sm:w-20 h-24 sm:h-16 bg-gray-200 rounded flex-shrink-0 overflow-hidden">
                                    ...
                                    @else
                                        <div class="w-full h-full flex items-center justify-center bg-gray-200 text-gray-400 text-xs text-center px-1">
                ...
                <div class="mb-4">
                    <div class="flex items-center space-x-2">
                        <div class="w-1 h-6 bg-green-600"></div>
                        <h2 class="text-lg font-bold text-green-600 uppercase">NHẬN ĐỊNH BÓNG ĐÁ HÔM NAY THEO GIẢI ĐẤU</h2>
                    </div>
                </div>
                ...
                @foreach($predictionsByLeague as $leagueId => $leaguePredictions)
                    ...
                    <div class="mb-6">
                        <div class="mb-3">
                            <h3 class="text-base font-bold text-gray-900">NHẬN ĐỊNH {{ strtoupper($leagueName) }}</h3>
                        </div>
